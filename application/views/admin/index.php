            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->ab_rental->get_data('mobil')->num_rows(); ?> </div>
                        <div>Jumlah Alat Berat</div>
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    <div class="huge">
                        <?php echo $this->ab_rental->get_data('kostumer')->num_rows(); ?> </div>
    ...
    <div class="panel panel-warning">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    <div class="huge">
                        <?php echo $this->ab_rental->get_data('transaksi ')->num_rows(); ?> </div>
        ...
        <div class="panel panel-danger">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->ab_rental->edit_data(array('transaksi_status' => 1), 'transaksi')->num_rows(); ?> </div>
